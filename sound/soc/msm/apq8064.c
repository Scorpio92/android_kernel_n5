 ...
 */
 ...
 //ZTEBSP weiguohua add it  for codec  start ,20120713
#ifdef CONFIG_ZTE_AVS_COMMON_MODIFY
//#define DEBUG
#endif
 //ZTEBSP weiguohua add it  for codec  end ,20120713
#include <linux/clk.h>
...
enum {
 ...
 //ZTEBSP weiguohua add it  for codec  start ,20120713
#ifdef CONFIG_ZTE_AVS_COMMON_MODIFY
static u32 top_spk_pamp_gpio  = PM8921_GPIO_PM_TO_SYS(17);
#else
...
static const struct snd_soc_dapm_route apq8064_common_audio_map[] = {
 ...
 //ZTEBSP weiguohua add it  for BACK MIC  start ,20121016	
#ifdef CONFIG_ZTE_AVS_COMMON_MODIFY
...
#endif
 //ZTEBSP weiguohua add it  for BACK MIC  end ,20121016
...
#define S(X, Y) ((TABLA_MBHC_CAL_PLUG_TYPE_PTR(tabla_cal)->X) = (Y))
	S(v_no_mic, 30);
	S(v_hs_max, 2850);//ZTEBSP lichuangchuang modify 2400 -> 2850 for headset detect,20121227
#undef S
