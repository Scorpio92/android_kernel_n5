...
static char wlan_info[51] = "Device manufacturing:Qualcomm Model Number:WCN3660";
...
static char bt_id[55] = "BT_Info = BT Information:Qualcomm Model Number:WCN3660";
...
#endif
	// added by yangze for wifi and bt product test 20121011 start
	create_wlan_info_proc_file();
	// added by yangze for wifi and bt product test 20121011 end
