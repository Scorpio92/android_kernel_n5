...
//-------------------------------------- BOE Power IC-----------------------------------------
	...
	static char boe_param37[2] = {0x00,0x92};//AVEE²ŸŠÜ©MNVDD18 ŠP®É¶}
	static char boe_param38[2] = {0xf5,0x06};

	static char boe_param39[2] = {0x00,0x94};//VCL²ŸŠÜ©MNVDD18 ŠP®É¶}
	static char boe_param40[2] = {0xf5,0x06};

	static char boe_param41[2] = {0x00,0x96};//VGH²ŸŠÜ©MVCOM ŠP®É¶}
	static char boe_param42[2] = {0xf5,0x0f};

	static char boe_param43[2] = {0x00,0x98};//VGH²ŸŠÜ©MVCOM ŠP®É¶}
