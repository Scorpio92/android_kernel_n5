...
// zte-modify, 20130227 fuyipeng modify from qualcomm patch +++
...
struct kgsl_mmu_ops iommu_ops = {
    ...
    .mmu_sync_lock = kgsl_iommu_sync_lock, // zte-modify, 20130227 fuyipeng modify from qualcomm patch
    .mmu_sync_unlock = kgsl_iommu_sync_unlock, // zte-modify, 20130227 fuyipeng modify from qualcomm patch
};
