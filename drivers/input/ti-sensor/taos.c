...
#endif
#endif
       struct i2c_adapter *taos_adapter = i2c_get_adapter(2);
...
//[ECID:000000] ZTEBSP wanghaifei end 20111018
    ...
    switch (cmd) {
        ...
        case TAOS_IOCTL_PROX_CALIBRATE:
            ...
            prox_mean = prox_sum/19;//modified by yangze first data is 0x00
            if(0x39 == chip_id){ //modified by yangze for TMD27723
		     taos_cfgp->prox_threshold_hi = ((((prox_max - prox_mean) * 300) + 50)/100) + prox_mean;            
		     taos_cfgp->prox_threshold_lo = ((((prox_max - prox_mean) * 270) + 50)/100) + prox_mean;
            }else{
