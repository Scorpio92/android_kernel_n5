...
#define MSM_CAM_IOCTL_GET_SENSOR_MODULE_ID \
    _IOW(MSM_CAM_IOCTL_MAGIC, 101, int16_t *)
// zte-modify, 20120831 fuyipeng modify for AF Rect for touch focus ---
...
enum eeprom_camera_module_id {//zhangzhao for 8064 eeprom
	EEPROM_CAMERA_MID_NULL  = 0,
	EEPROM_CAMERA_MID_SUNNY = 1,  // 1
	EEPROM_CAMERA_MID_TRULY  = 2,  //  2
	EEPROM_CAMERA_MID_AKERR = 3,
	EEPROM_CAMERA_MID_LITEARRAY  =4,
	EEPROM_CAMERA_MID_DARLING     =5,
	EEPROM_CAMERA_MID_QTECH  =6,  // 6
	EEPROM_CAMERA_MID_OFLIM   =7,  // 7
	EEPROM_CAMERA_MID_FOXCONN  =  0x11,// 0x11
	EEPROM_CAMERA_MID_IMPORTEK  =  0x12,// 0x11
	EEPROM_CAMERA_MID_ALTEK  =  0x13,
	EEPROM_CAMERA_MID_ABICO  =  0x14,
	EEPROM_CAMERA_MID_LITEON =  0x15,
	EEPROM_CAMERA_MID_CHICONY  =  0x16,
	EEPROM_CAMERA_MID_PRIMAX  =  0x17,
	EEPROM_CAMERA_MID_SHARP  =  0x21,
	EEPROM_CAMERA_MID_MCNEX  =  0x31,
	EEPROM_CAMERA_MID_MCNEX_ALL  =  0xa0,
